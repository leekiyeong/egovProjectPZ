...
public class CafeServiceImpl implements CafeService {
	...
	public boolean signup(CafeVo vo) throws Exception {
		...
		File saveFile = new File("C:/eGov/eGovFrameDev-4.0.0-64bit/workspace/pz-1.0.0/src/main/webapp/resources/image/"+vo.getPhotopath());
		File saveFile2 = new File("C:/eGov/eGovFrameDev-4.0.0-64bit/workspace/pz-1.0.0/src/main/webapp/resources/image/"+vo.getCertifypath());
...
vo.setMenuInfos();
		...
		for(int i = 0; i < fileNames.length; i ++) {
			...
			File saveFile = new File("C:/eGov/eGovFrameDev-4.0.0-64bit/workspace/pz-1.0.0/src/main/webapp/resources/image/"+fileOriginalName);
